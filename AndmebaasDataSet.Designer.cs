...
namespace AndmebaasWin.AndmebaasDataSetTableAdapters {
    ...
    public partial class ToodeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Toode] WHERE (([Id] = @Original_Id) AND ([Nimetus] = @Original" +
                "_Nimetus) AND ((@IsNull_Kogus = 1 AND [Kogus] IS NULL) OR ([Kogus] = @Original_K" +
                "ogus)) AND ((@IsNull_Hind = 1 AND [Hind] IS NULL) OR ([Hind] = @Original_Hind)))" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Toode] SET [Nimetus] = @Nimetus, [Kogus] = @Kogus, [Hind] = @Hind WHERE (([Id] = @Original_Id) AND ([Nimetus] = @Original_Nimetus) AND ((@IsNull_Kogus = 1 AND [Kogus] IS NULL) OR ([Kogus] = @Original_Kogus)) AND ((@IsNull_Hind = 1 AND [Hind] IS NULL) OR ([Hind] = @Original_Hind)));
SELECT Id, Nimetus, Kogus, Hind FROM Toode WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AndmebaasWin.Properties.Settings.Default.AndmebaasConnectionString;
        }
